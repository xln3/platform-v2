...
def test_answer_to_brand_record_shape():
    rec = adapter.answer_to_brand_record(
        _answer(mode="deep_think", region="上海", query_text="保险产品排行", model="deepseek"),
        ["中意人寿", "中国平安"],
    )
...
def test_citation_to_source_entry_host_normalized():
    row = {
        "ordinal": 2,
        "host": "www.Zhihu.com",
        "canonical_url": "https://www.zhihu.com/a",
        "original_url": "https://www.zhihu.com/a",
    }
...
def test_citation_to_source_entry_url_host_fallback():
    ...
    row = {"ordinal": 1, "host": "", "canonical_url": "https://www.163.com/c", "original_url": ""}
    assert adapter.citation_to_source_entry(row)["sitename"] == "163.com"
    row2 = {
        "ordinal": 3,
        "host": None,
        "canonical_url": "",
        "original_url": "https://baijiahao.baidu.com/s",
    }
...
def test_citation_to_source_entry_bad_ordinal_defensive():
    ...
    row = {
        "ordinal": 0,
        "host": "zhihu.com",
        "canonical_url": "https://zhihu.com/a",
        "original_url": "",
    }
