...
def test_normalize_fuzzy_length_ratio_boundary():
    ...
    r = DomainRules(domain="t", category="c",
                    merge_rules={"甲乙": "甲乙公司"}, exclude_terms=frozenset())
