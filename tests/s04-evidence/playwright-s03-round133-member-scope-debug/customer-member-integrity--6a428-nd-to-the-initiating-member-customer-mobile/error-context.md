...
- generic [ref=e2]:
  ...
  - generic [ref=e24]:
    - banner [ref=e25]:
      - button "租户 · egrity · 成员完整性项目 ⌄" [ref=e26] [cursor=pointer]
      - generic [ref=e27]:
        - button "通知" [ref=e28] [cursor=pointer]: ◌
        - generic "用户 · _admin" [ref=e29]: 用
    - main [ref=e30]:
      - generic [ref=e31]:
        - generic [ref=e32]:
          - text: Customer Web
      ...
      - generic [ref=e38]:
        - generic [ref=e39]:
          - heading "项目成员" [level=2] [ref=e40]
          - paragraph [ref=e41]: 客户管理员可以管理本租户成员；邮箱在列表和审计中保持掩码。
          - generic [ref=e42]:
            - article [ref=e43]:
              - generic [ref=e44]: 租
              - generic [ref=e45]:
                - strong [ref=e46]: 租户管理员
                - generic [ref=e47]: a***@example.test
              - generic [ref=e48]: 客户管理员
              - button "管理 租户管理员" [ref=e49] [cursor=pointer]: 管理
            - article [ref=e50]:
              - generic [ref=e51]: 成
              - generic [ref=e52]:
                - strong [ref=e53]: 成员甲
                - generic [ref=e54]: a***@example.test
              - generic [ref=e55]: 客户成员
              - button "管理 成员甲" [active] [ref=e56] [cursor=pointer]: 管理
            - article [ref=e57]:
              - generic [ref=e58]: 成
              - generic [ref=e59]:
                - strong [ref=e60]: 成员乙
                - generic [ref=e61]: b***@example.test
              - generic [ref=e62]: 客户成员
              - button "管理 成员乙" [ref=e63] [cursor=pointer]: 管理
        - generic [ref=e64]:
          - heading "邀请成员" [level=2] [ref=e65]
          - generic [ref=e66]:
            - generic [ref=e67]: 姓名
            - textbox "姓名" [ref=e68]
          - generic [ref=e69]:
            - generic [ref=e70]: 工作邮箱
            - textbox "工作邮箱" [ref=e71]
          - generic [ref=e72]:
            - generic [ref=e73]: 项目角色
            - combobox "项目角色" [ref=e74]:
              - option "客户成员" [selected]
              - option "客户管理员"
          - button "发送邀请" [ref=e75] [cursor=pointer]
```
