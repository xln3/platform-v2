...
- generic [ref=e2]:
  ...
  - complementary [ref=e4]:
    ...
    - navigation "Customer Web 主导航" [ref=e7]:
      ...
      - button "监测表现" [active] [ref=e12] [cursor=pointer]: •
  ...
  - generic [ref=e17]:
    - banner [ref=e18]:
      - button "租户 · bidden · 不可推断项目 ⌄" [ref=e19] [cursor=pointer]
      - generic [ref=e20]:
        - button "通知" [ref=e21] [cursor=pointer]: ◌
        - generic "用户 · bidden" [ref=e22]: 用
    - main [ref=e23]:
      - generic [ref=e24]:
        - generic [ref=e25]:
          - text: Customer Web
      ...
      - status [ref=e31]:
        - generic [ref=e33]:
          - strong [ref=e34]: 无权查看
          - paragraph [ref=e35]: 当前角色没有此资源权限，也不会披露资源是否存在。
```
