...
- generic [ref=e2]:
  ...
  - complementary [ref=e4]:
    - navigation "Customer Web 主导航" [ref=e5]:
      ...
      - button "监测表现" [active] [ref=e14] [cursor=pointer]:
  ...
  - generic [ref=e24]:
    - banner [ref=e25]:
      - button "租户 · bidden · 不可推断项目 ⌄" [ref=e26] [cursor=pointer]
      - generic [ref=e27]:
        - button "通知" [ref=e28] [cursor=pointer]: ◌
        - generic "用户 · bidden" [ref=e29]: 用
    - main [ref=e30]:
      - generic [ref=e31]:
        - generic [ref=e32]:
          - text: Customer Web
      ...
      - status [ref=e38]:
        - generic [ref=e40]:
          - strong [ref=e41]: 无权查看
          - paragraph [ref=e42]: 当前角色没有此资源权限，也不会披露资源是否存在。
```
