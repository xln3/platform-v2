...
const workspaces = [
  ...
  {
    section: 'services',
    snapshot: 'customer-services.png',
    ready: '我的五项服务',
  },
  {
    section: 'service-1',
    snapshot: 'customer-service-1.png',
    ready: 'AI 推荐排名效果测试',
  },
  {
    section: 'service-2',
    snapshot: 'customer-service-2.png',
    ready: '主动拉踩内容核查',
  },
  {
    section: 'service-3',
    snapshot: 'customer-service-3.png',
    ready: '被拉踩内容核查',
  },
  {
    section: 'service-4',
    snapshot: 'customer-service-4.png',
    ready: '官网内容 AI 引用效率分析',
  },
  {
    section: 'service-5',
    snapshot: 'customer-service-5.png',
    ready: '内容发布与排名提升试点',
  },
  {
    section: 'evidence',
