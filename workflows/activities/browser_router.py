...
_ISO_TO_GB_31 = {
    "CN-BJ": "110000", "CN-TJ": "120000", "CN-HE": "130000", "CN-SX": "140000",
    "CN-NM": "150000", "CN-LN": "210000", "CN-JL": "220000", "CN-HL": "230000",
    "CN-SH": "310000", "CN-JS": "320000", "CN-ZJ": "330000", "CN-AH": "340000",
    "CN-FJ": "350000", "CN-JX": "360000", "CN-SD": "370000", "CN-HA": "410000",
    "CN-HB": "420000", "CN-HN": "430000", "CN-GD": "440000", "CN-GX": "450000",
    "CN-HI": "460000", "CN-CQ": "500000", "CN-SC": "510000", "CN-GZ": "520000",
    "CN-YN": "530000", "CN-XZ": "540000", "CN-SN": "610000", "CN-GS": "620000",
    "CN-QH": "630000", "CN-NX": "640000", "CN-XJ": "650000",
}
...
_CITY_NAME_TO_GB = {
    ...
    "石家庄": "130100", "太原": "140100", "呼和浩特": "150100", "沈阳": "210100",
    "长春": "220100", "哈尔滨": "230100", "合肥": "340100", "福州": "350100",
    "南昌": "360100", "济南": "370100", "郑州": "410100", "南宁": "450100",
    "海口": "460100", "贵阳": "520100", "昆明": "530100", "拉萨": "540100",
...
def resolve_browser_instance(platform: str, region: str) -> InstanceRoute:
    ...
    candidates = [
        _load_instance(key) for key in _instance_keys() if key.split("_", 1)[0] == slug
    ]
    if not candidates:
        raise _fail(
            "browser_instance_unavailable",
            f"no resident browser instance for platform {slug!r} in "
            f"{ENV_BROWSER_INSTANCES}",
        )
