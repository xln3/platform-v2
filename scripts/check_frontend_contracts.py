...
if api_client.count("client: ProjectedApiClientOverride = apiClient") != 150:
    errors.append(
        "@geo/api-client must keep all 150 projected wrapper overrides free of the raw "
...
if projected_client_unwraps != 150:
    errors.append(
...
for fragment in (
    ...
    "projection: { total: 5, shown: 4, invalid: true }",
):
    if fragment not in api_client_tests:
