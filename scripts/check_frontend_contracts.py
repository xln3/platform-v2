...
if api_client.count("client: ProjectedApiClientOverride = apiClient") != 113:
    errors.append(
        "@geo/api-client must keep all 113 projected wrapper overrides free of the raw "
...
if projected_client_unwraps != 113:
    errors.append(
